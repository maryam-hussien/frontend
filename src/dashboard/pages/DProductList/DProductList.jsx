...
function DProductList() {
  ...
  const getProducts = async () => {
    try {
      const response = await axios.get("https://backend-swart-theta.vercel.app/item/all");
    ...
    const handleDelete = async (id) => {
      try {
        console.log(id);
        const response = await axios.delete(`https://backend-swart-theta.vercel.app/item/delete/${id}`);
