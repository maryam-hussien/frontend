...
function DProductList() {
    ...
    const getOrders = async () => {
      try {
        const response = await axios.get("https://backend-swart-theta.vercel.app/order/all", {
          headers: {
      ...
      const handleDelete = async(id) => {
        try{
          const response = axios.delete(`https://backend-swart-theta.vercel.app/order/delete/${id}`)
