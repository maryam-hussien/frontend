...
function Authentication() {
  ...
  const signUp = async () => {
    try {
      ...
      const response = await axios.post('https://backend-swart-theta.vercel.app/user/register', formData);
  ...
  const signIn = async ({ email, password }) => {
    try {
      const response = await axios.post('https://backend-swart-theta.vercel.app/user/login', { email, password });
